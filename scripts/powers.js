...
const powersLoring = new Map([
	...
	["ap31", "When an attuned wielder sees a creature within 60ft take damage, they may choose to use their reaction and spend a charge to transfer the damage to themselves. If they choose to do so, they deal an additional 1d6 damage on their next attack with their hex-weapon."],
	["ap32", "When an attuned wielder sees a creature within 90ft take damage, they may choose to use their reaction and spend a charge to transfer the damage to themselves. If they choose to do so, they deal an additional 2d6 damage on their next attack with their hex-weapon and they get advantage on the attack if the attacked creature is the source of the damage."],
	["ap33", "When an attuned wielder sees a creature within 90ft take damage, they may choose to use their reaction and spend a charge to transfer the damage to themselves. If they choose to do so, they deal an additional 3d6 damage on their next attack with their hex-weapon, this attack also gains advantage on the attack and rolls three d20 for advantage instead of the normal two."],
...
export let powers = new Map([
	["vonnom", powersVonnom],
	["almar", powersAlmar],
	["loring", powersLoring],
	["peculiar", powersPeculiar]
]);